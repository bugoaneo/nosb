!function(e) {
    ...
    (t = function() {
        ...
        o = -1 * t.options.slidesToScroll, e = 2 * t.slideCount); e > i; ) s.push(i), i = o + t.options.slidesToScroll, 
        ...
        s <= n.slideCount && s++)), t(n.$slider.find(".slick-slide").slice(o, s)), n.slideCount <= n.options.slidesToShow ? (i = n.$slider.find(".slick-slide"), 
        t(i)) : n.currentSlide >= n.slideCount - n.options.slidesToShow ? (i = n.$slider.find(".slick-cloned").slice(0, n.options.slidesToShow), 
        t(i)) : 0 === n.currentSlide && (i = n.$slider.find(".slick-cloned").slice(-1 * n.options.slidesToShow), 
        t(i));
        ...
        r.length ? (i = r.first(), o = i.attr("data-lazy"), s = document.createElement("img"), 
        s.onload = function() {
            i.attr("src", o).removeAttr("data-lazy").removeClass("slick-loading"), !0 === n.options.adaptiveHeight && n.setPosition(), 
            n.$slider.trigger("lazyLoaded", [ n, i, o ]), n.progressiveLazyLoad();
        }, s.onerror = function() {
            3 > t ? setTimeout(function() {
                n.progressiveLazyLoad(t + 1);
            }, 500) : (i.removeAttr("data-lazy").removeClass("slick-loading").addClass("slick-lazyload-error"), 
            n.$slider.trigger("lazyLoadError", [ n, i, o ]), n.progressiveLazyLoad());
        ...
        var o = this;
        return "boolean" == typeof e ? (t = e, e = !0 === t ? 0 : o.slideCount - 1) : e = !0 === t ? --e : e, 
        !(o.slideCount < 1 || 0 > e || e > o.slideCount - 1) && (o.unload(), !0 === i ? o.$slideTrack.children().remove() : o.$slideTrack.children(this.options.slide).eq(e).remove(), 
        ...
        if ("object" === e.type(arguments[0]) ? (o = arguments[0], a = arguments[1], n = "multiple") : "string" === e.type(arguments[0]) && (o = arguments[0], 
        s = arguments[1], a = arguments[2], "responsive" === arguments[0] && "array" === e.type(arguments[1]) ? n = "responsive" : void 0 !== arguments[1] && (n = "single")), 
        "single" === n) r.options[o] = s; else if ("multiple" === n) e.each(o, function(e, t) {
            r.options[e] = t;
        ...
        !1 === d.options.infinite && !1 === d.options.centerMode && (0 > e || e > d.getDotCount() * d.options.slidesToScroll) ? void (!1 === d.options.fade && (o = d.currentSlide, 
        !0 !== i ? d.animateSlide(r, function() {
            d.postSlide(o);
        }) : d.postSlide(o))) : !1 === d.options.infinite && !0 === d.options.centerMode && (0 > e || e > d.slideCount - d.options.slidesToScroll) ? void (!1 === d.options.fade && (o = d.currentSlide, 
        !0 !== i ? d.animateSlide(r, function() {
            d.postSlide(o);
        ...
        i = Math.atan2(t, e), 0 > (o = Math.round(180 * i / Math.PI)) && (o = 360 - Math.abs(o)), 
        ...
        for (e = 0; r > e; e++) if ("object" == typeof s || void 0 === s ? o[e].slick = new t(o[e], s) : i = o[e].slick[s].apply(o[e].slick, n), 
        void 0 !== i) return i;
        return o;
    };
}), function(e) {
    ...
    var t, i, o, s, n, r, a = "Close", l = "BeforeClose", d = "MarkupParse", c = "Open", p = "Change", u = "mfp", f = "." + u, h = "mfp-ready", m = "mfp-removing", v = "mfp-prevent-close", g = function() {}, y = !!window.jQuery, w = e(window), k = function(e, i) {
        t.ev.on(u + e + f, i);
    }, T = function(t, i, o, s) {
        var n = document.createElement("div");
        return n.className = "mfp-" + t, o && (n.innerHTML = o), s ? i && i.appendChild(n) : (n = e(n), 
        i && n.appendTo(i)), n;
    }, S = function(i, o) {
        t.ev.triggerHandler(u + i, o), t.st.callbacks && (i = i.charAt(0).toLowerCase() + i.slice(1), 
    ...
    g.prototype = {
        ...
        init: function() {
            ...
            t.isIOS = /iphone|ipad|ipod/gi.test(i), t.supportsTransition = $(), t.probablyMobile = t.isAndroid || t.isIOS || /(Opera Mini)|Kindle|webOS|BlackBerry|(Opera Mobi)|(Windows Phone)|IEMobile/i.test(navigator.userAgent), 
        ...
        open: function(i) {
            ...
            {
                if (!t.isOpen) {
                    t.types = [], n = "", i.mainEl && i.mainEl.length ? t.ev = i.mainEl.eq(0) : t.ev = o, 
                    ...
                    t.st.enableEscapeKey = !1), t.bgOverlay || (t.bgOverlay = T("bg").on("click" + f, function() {
                        t.close();
                    }), t.wrap = T("wrap").attr("tabindex", -1).on("click" + f, function(e) {
                    ...
                    }), n += " mfp-close-btn-in") : t.wrap.append(b())), t.st.alignTop && (n += " mfp-align-top"), 
                    ...
                    S("BuildControls"), e("html").css(m), t.bgOverlay.add(t.wrap).prependTo(t.st.prependTo || e(document.body)), 
                    ...
                    }, 16), t.isOpen = !0, t.updateSize(u), S(c), i;
                }
                t.updateItemHTML();
            }
        },
        close: function() {
            t.isOpen && (S(l), t.isOpen = !1, t.st.removalDelay && !t.isLowIE && t.supportsTransition ? (t._addClassToMFP(m), 
            setTimeout(function() {
                t._close();
        ...
        _close: function() {
            ...
            o.off("keyup.mfp focusin" + f), t.ev.off(f), t.wrap.attr("class", "mfp-wrap").removeAttr("style"), 
            ...
            t.content = null, t.currTemplate = null, t.prevHeight = 0, S("AfterClose");
        },
        ...
        updateItemHTML: function() {
            ...
            var o = i.type;
            if (S("BeforeChange", [ t.currItem ? t.currItem.type : "", o ]), t.currItem = i, 
            !t.currTemplate[o]) {
                var n = !!t.st[o] && t.st[o].markup;
                S("FirstMarkupParse", n), t.currTemplate[o] = !n || e(n);
            }
            s && s !== i.type && t.container.removeClass("mfp-" + s + "-holder");
            var r = t["get" + o.charAt(0).toUpperCase() + o.slice(1)](i, t.currTemplate[o]);
            t.appendContent(r, o), i.preloaded = !0, S(p, i), s = i.type, t.container.prepend(t.contentContainer), 
            S("AfterChange");
        },
        appendContent: function(e, i) {
            t.content = e, e ? t.st.showCloseBtn && t.st.closeBtnInside && !0 === t.currTemplate[i] ? t.content.find(".mfp-close").length || t.content.append(b()) : t.content = e : t.content = "", 
            S("BeforeAppend"), t.container.addClass("mfp-" + i + "-holder"), t.contentContainer.append(t.content);
        },
        parseEl: function(i) {
            var o, s = t.items[i];
            if (s.tagName ? s = {
            ...
            return s.type = o || t.st.type || "inline", s.index = i, s.parsed = !0, t.items[i] = s, 
            S("ElementParse", s), t.items[i];
        },
        addGroup: function(e, i) {
            ...
            i.mainEl = e, i.items ? (i.isObj = !0, e.off(s).on(s, o)) : (i.isObj = !1, i.delegate ? e.off(s).on(s, i.delegate, o) : (i.items = e, 
            e.off(s).on(s, o)));
        },
        _openClick: function(i, o, s) {
            if ((void 0 !== s.midClick ? s.midClick : e.magnificPopup.defaults.midClick) || !(2 === i.which || i.ctrlKey || i.metaKey || i.altKey || i.shiftKey)) {
                ...
                s.delegate && (s.items = o.find(s.delegate)), t.open(s);
            }
        },
        updateStatus: function(e, o) {
            if (t.preloader) {
                ...
                S("UpdateStatus", s), e = s.status, o = s.text, t.preloader.html(o), t.preloader.find("a").on("click", function(e) {
        ...
        _parseMarkup: function(t, i, o) {
            var s;
            o.data && (i = e.extend(o.data, i)), S(d, [ t, i, o ]), e.each(i, function(i, o) {
        ...
        if ("string" == typeof i) if ("open" === i) {
            var s, n = y ? o.data("magnificPopup") : o[0].magnificPopup, r = parseInt(arguments[1], 10) || 0;
            n.items ? s = n.items[r] : (s = o, n.delegate && (s = s.find(n.delegate)), s = s.eq(r)), 
            t._openClick({
                mfpEl: s
            }, o, n);
            ...
            getInline: function(i, o) {
                if (A(), i.src) {
                    ...
                    if (n.length) {
                        ...
                        r && r.tagName && (I || (x = s.hiddenClass, I = T(x), x = "mfp-" + x), P = n.after(I).detach().removeClass(x)), 
    ...
    e.magnificPopup.registerModule(E, {
        ...
        proto: {
            initAjax: function() {
                t.types.push(E), z = t.st.ajax.cursor, k(a + "." + E, M), k("BeforeChange." + E, M);
            },
            getAjax: function(i) {
                ...
                var o = e.extend({
                    ...
                    success: function(o, s, n) {
                        ...
                        S("ParseAjax", r), t.appendContent(e(r.data), E), i.finished = !0, H(), t._setFocus(), 
                        setTimeout(function() {
                            t.wrap.addClass(h);
    ...
    e.magnificPopup.registerModule("image", {
        ...
        proto: {
            ...
            _onImageHasSize: function(e) {
                e.img && (e.hasSize = !0, L && clearInterval(L), e.isCheckingImgSize = !1, S("ImageHasSize", e), 
                e.imgHidden && (t.content && t.content.removeClass("mfp-loading"), e.imgHidden = !1));
            },
            findImageSize: function(e) {
                var i = 0, o = e.img[0], s = function(n) {
                    L && clearInterval(L), L = setInterval(function() {
                        return o.naturalWidth > 0 ? void t._onImageHasSize(e) : (i > 200 && clearInterval(L), 
                        i++, void (3 === i ? s(10) : 40 === i ? s(50) : 100 === i && s(500)));
                    }, n);
                };
                s(1);
            },
            getImage: function(i, o) {
                var s = 0, n = function() {
                    ...
                    t.updateStatus("ready")), i.hasSize = !0, i.loaded = !0, S("ImageLoadComplete")) : (s++, 
                    200 > s ? setTimeout(n, 100) : r()));
                }, r = function() {
                    i && (i.img.off(".mfploader"), i === t.currItem && (t._onImageHasSize(i), t.updateStatus("error", a.tError.replace("%url%", i.src))), 
                    i.hasSize = !0, i.loaded = !0, i.loadError = !0);
                }, a = t.st.image, l = o.find(".mfp-img");
                if (l.length) {
                    var d = document.createElement("img");
                    d.className = "mfp-img", i.el && i.el.find("img").length && (d.alt = i.el.find("img").attr("alt")), 
                    i.img = e(d).on("load.mfploader", n).on("error.mfploader", r), d.src = i.src, l.is("img") && (i.img = i.img.clone()), 
                ...
                t.updateStatus("ready")), o) : (t.updateStatus("loading"), i.loading = !0, i.hasSize || (i.imgHidden = !0, 
                o.addClass("mfp-loading"), t.findImageSize(i)), o);
            }
        }
    });
    var j, D = function() {
    ...
    e.magnificPopup.registerModule("zoom", {
        ...
        proto: {
            initZoom: function() {
                ...
                if (i.enabled && t.supportsTransition) {
                    var s, n, r = i.duration, d = function(e) {
                        var t = e.clone().removeAttr("style").removeAttr("class").addClass("mfp-animated-image"), o = "all " + i.duration / 1e3 + "s " + i.easing, s = {
                            position: "fixed",
                            zIndex: 9999,
                            left: 0,
                            top: 0,
                    ...
                    k("BuildControls" + o, function() {
                        ...
                        if (t._allowZoom()) {
                            ...
                            n.css(t._getOffset(!0)), t.wrap.append(n), t.content.css("visibility", "hidden"), 
                            setTimeout(function() {
                                n.css(t._getOffset());
                            }, 16);
                        }
            ...
            _getOffset: function(i) {
                var o, s = (o = i ? t.currItem.img : t.st.zoom.opener(t.currItem.el || t.currItem)).offset(), n = parseInt(o.css("padding-top"), 10), r = parseInt(o.css("padding-bottom"), 10);
                s.top -= e(window).scrollTop() - n;
                var a = {
                    width: o.width(),
                    height: (y ? o.innerHeight() : o[0].offsetHeight) - r - n
                };
                return D() ? a["-moz-transform"] = a.transform = "translate(" + s.left + "px," + s.top + "px)" : (a.left = s.left, 
                a.top = s.top), a;
            }
        }
    });
    var W = "iframe", B = function(e) {
        if (t.currTemplate[W]) {
        ...
        proto: {
            ...
            getIframe: function(i, o) {
                ...
                e.each(n.patterns, function() {
                    ...
                    s = this.src.replace("%id%", s), !1) : void 0;
                });
                var r = {};
                return n.srcAction && (r[n.srcAction] = s), t._parseMarkup(o, r, i), t.updateStatus("ready"), 
                o;
            }
        }
    });
            ...
            initGallery: function() {
                ...
                return t.direction = !0, !(!i || !i.enabled) && (n += " mfp-gallery", k(c + s, function() {
                    ...
                    if (t.items.length > 1 && i.arrows && !t.arrowLeft) {
                        var o = i.arrowMarkup, s = t.arrowLeft = e(o.replace(/%title%/gi, i.tPrev).replace(/%dir%/gi, "left")).addClass(v), n = t.arrowRight = e(o.replace(/%title%/gi, i.tNext).replace(/%dir%/gi, "right")).addClass(v);
                        s.click(function() {
                            t.prev();
                        }), n.click(function() {
                            t.next();
        ...
        proto: {
            initRetina: function() {
                if (window.devicePixelRatio > 1) {
                    ...
                    (i = isNaN(i) ? i() : i) > 1 && (k("ImageHasSize." + N, function(e, t) {
                        t.img.css({
                            "max-width": t.img[0].naturalWidth / i,
                            width: "100%"
                        });
                    }), k("ElementParse." + N, function(t, o) {
    ...
    function e() {
        (t = new ymaps.Map("map", {
            ...
            zoom: 16
        })).controls.remove("searchControl").remove("trafficControl").remove("geolocationControl").remove("zoomControl").remove("rulerControl").remove("typeSelector"), 
        t.behaviors.disable([ "scrollZoom" ]), t.behaviors.get("drag").disable(), (i = new ymaps.Placemark([ 55.753994, 37.622093 ], {}, {
            iconImageHref: "../img/icons/big-pin.png",
            iconImageSize: [ 32, 46 ],
            iconImageOffset: [ -3, -42 ]
        })).id = id, t.geoObjects.add(i);
    }
    $(".nav-toggle").click(function() {
        ...
        var e = $(this).attr("href"), t = $(e).offset().top - 0;
